...
public class RootPane extends BorderPane {
    ...
    public RootPane(DesenhoObs desenho){
        this.desenho = desenho;
      criaLayout();
      registaListeners();
      desenho.addObserver(DesenhoObs.COR, e-> {atualizaBotaoCorAtivo();});
      desenho.addObserver(DesenhoObs.TIPOFIGURA, e-> {atualizaBotaoTipoAtivo();});
    }
